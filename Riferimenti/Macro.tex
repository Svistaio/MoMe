...
\controllaClasse{% Classe «article»    
    ...
    \newcommand\FKcontinuous{[FK]$_c$}   %\teqref{eqFKContinuous}{[FK]$_c$}}
    \newcommand\HDcontinuous{[ED]$_c$}   %\teqref{eqHDContinuous}{[ED]$_c$}}
    \newcommand\SMOcontinuous{[SMO]$_c$} %\teqref{eqSMOContinuous}{[SMO]$_c$}}
}%
...
\controllaClasse{% Classe «article»    
    ...
    \newcommand\FKdiscrete{[FK]$_d$}   %\teqref{eqFKDiscrete}{[FK]$_d$}}
    \newcommand\HDdiscrete{[ED]$_d$}   %\teqref{eqHDDiscrete}{[ED]$_d$}}
    \newcommand\SMOdiscrete{[SMO]$_d$} %\teqref{eqSMODiscrete}{[SMO]$_d$}}
}%
...
\newcommand\didascalia[2]{%
    \captionsetup{aboveskip=-.2cm,width=#2}
...
\newcommand\includetikzgroupplotfigure@star[7]{%
    \begin{figure*}[#1]%
        \vspace{#2}%
        \centering%
        \refstepcounter{figure}%
...
\newcommand\dimColla[3]{#1#3 plus #2#3 minus #2#3}
\newcommand\vColla[3]{\vspace{\dimColla{#1}{#2}{#3}}}
\newcommand\hColla[3]{\hspace{\dimColla{#1}{#2}{#3}}}

% Hadamard product symbol
