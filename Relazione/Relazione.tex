    ...
    \section{Kinetic models} \label{secKineticModels}
        ...
        \subsection{Complications}\label{secComplications}
            ...
            \subsubsection{Size-dependency}\label{secComplicationsSizeDependency}
                ...
                For clearance, \ref{hypSMOModelClearance} can be modified by setting $\mu_i=\mu/i$; in this way, the larger the polymer is, the slower it will diffuse. This last change actually breaks mass conservation in \eqref{eqMassConservation} which becomes \cite[(47) on p. 8]{Goriely2019}
                %
                \begin{equation}
        ...
        \subsection{Settings}\label{secSettings}
            ...
            \subsubsection{SMO model}\label{secSettingsSMO}
                ...
                \begin{itemize}[%
                    ...
                    %
                    %
                    \item the initial healthy concentration is $c_{1,0}=\qty2{\molarity}=\gamma/\mu$, while the nucleation rate takes value
                    %
                    \begin{equation}
